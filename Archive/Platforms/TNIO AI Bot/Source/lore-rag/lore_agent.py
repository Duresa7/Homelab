...
def _is_intelligence_nfu_join_question(question: str) -> bool:
    q = question or ""
    return _is_nfu_text(q) and bool(re.search(r"\b(intelligence|intel)\b", q, re.I)) and bool(re.search(r"\b(join|require|requires|required|requirement|requirements|rank|minimum|eligible|eligibility)\b", q, re.I))
