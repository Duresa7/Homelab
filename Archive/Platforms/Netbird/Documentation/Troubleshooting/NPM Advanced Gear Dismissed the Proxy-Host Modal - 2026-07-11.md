...
**Corrective action:** I reopened the form and saved the basic proxy host first with upstream `http://netbird-dashboard:80`, Block Common Exploits, and WebSocket Support. After the Online host row appeared, I reopened it and applied the 1,296-character [checked-in advanced configuration](../../../../../Platforms/Nginx%20Proxy%20Manager/Configuration/netbird-advanced-config.conf).
