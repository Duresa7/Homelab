# TeamSpeak Three-Server Hosting Walkthrough
...
`alpha-prod-01` runs Debian 13 at `192.168.80.118` on VLAN 80. The three TeamSpeak containers use UDP 9987, 9988, & 9989; ServerQuery uses TCP 10011, 10012, & 10013; file transfer uses TCP 30033, 30034, & 30035. TS3 Manager listens on host port 9000 and is available internally at `https://ts3-manager.alphasecunited.com` through NPM. The shared Playit image is `ghcr.io/playit-cloud/playit-agent:0.17`.
...
- Internal DNS access to `https://ts3-manager.alphasecunited.com`, or direct browser access to `http://192.168.80.118:9000`.

## How the Pieces Fit Together

![TeamSpeak servers, shared Playit tunnels, and Cloudflare SRV records](../Assets/Diagrams/teamspeak.svg)
