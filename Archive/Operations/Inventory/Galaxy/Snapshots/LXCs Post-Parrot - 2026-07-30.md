...
I carried the complete LXC inventory forward after the Kasm Parrot build-out. No LXC configuration changed. Galaxy has six active LXCs on grey, blue, or red for automation, Docker, monitoring, remote access, and media. Stopped CT 105 `ai-bravo-02` remains defined on grey pending its scheduled 2026-08-15 deletion, but its configuration lives in the archive instead of this active inventory.
...
CT 104 `ai-alpha-01` no longer exists in Galaxy. I preserved its last recorded configuration, OpenClaw deployment records, & retirement verification in the [2026-07-25 retired guest record](../AI%20Alpha%2001%20Retired%20Guest%20-%202026-07-25.md).

CT 105 `ai-bravo-02` remains defined but stopped on `grey-server`, with autostart disabled. I moved its TNIO source, tests, configuration, records, walkthrough, & live configuration snapshot into the [2026-07-25 archived guest record](../AI%20Bravo%2002%20Archived%20Guest%20-%202026-07-25.md); deletion is scheduled for 2026-08-15.
