...
Galaxy had six active LXCs on Grey, Blue, or Red for automation, Docker, monitoring, remote access, and media when I captured this snapshot. Stopped CT 105 `ai-bravo-02` remained defined on Grey pending its scheduled 2026-08-15 deletion, but its configuration lived in the archive instead of this active inventory.
