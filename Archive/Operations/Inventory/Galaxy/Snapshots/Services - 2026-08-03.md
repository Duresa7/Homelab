...
I captured this complete workload snapshot after deploying Wazuh agents across twelve new endpoints. The inventory maps 13 Galaxy guests to their current workloads, versions, listeners, & verification state. It also records active Wazuh identities on all five Proxmox nodes.
