...
I captured this complete workload snapshot after adding an internal documentation workload to Docker Main. The inventory maps 13 Galaxy guests to their current workloads, versions, listeners, & verification state; the final table records node_exporter on all four Proxmox nodes.
