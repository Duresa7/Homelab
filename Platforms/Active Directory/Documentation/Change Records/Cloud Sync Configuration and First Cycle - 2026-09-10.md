...
2. ~~Decide when to move `DK-user@alphasecunited.com` from cloud-only onto the directory by soft match.~~ Done 10:50 PM on 2026-09-10; see [Owner Account Soft Match](Owner%20Account%20Soft%20Match%20-%202026-09-10.md).
