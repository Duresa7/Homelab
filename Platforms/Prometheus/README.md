...
The 2026-07-13 baseline cleanup installed the three missing Proxmox exporters, removed stale scrape jobs, and proved all seven retained jobs `UP`. See [Security Monitoring Baseline Cleanup - 2026-07-13](Documentation/Change%20Records/Security%20Monitoring%20Baseline%20Cleanup%20-%202026-07-13.md).
