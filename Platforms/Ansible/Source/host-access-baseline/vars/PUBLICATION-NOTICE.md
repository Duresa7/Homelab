...
A public key is not a secret in the operational sense — it is safe to hand to a host. It is withheld here because the repository is public and [0001-publication-policy](../../../../../Governance/Decisions/0001-publication-policy.md) treats keys as withheld. Copy the example when deploying.
