...
|---|---|---|
| S01-S03 | [Account and SSH verification](Logs/S01-Account-and-SSH-Verification-2026-07-25.md) | Credential metadata, account state, restricted controller key, passwordless sudo, Docker group scope, key-only SSH, old-key removal, & staging-file cleanup |
