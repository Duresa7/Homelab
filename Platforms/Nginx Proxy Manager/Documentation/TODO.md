...
Operational status is complete. Further hardening was intentionally descoped on 2026-07-12; NPM remains internal-only with no WAN ingress and intentionally tracks `latest`.
