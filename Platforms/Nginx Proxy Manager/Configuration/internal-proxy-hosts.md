...
| `grafana.<YOUR_BASE_DOMAIN>` | `192.168.72.2:3000` | HTTP | Grafana's domain & root URL use the HTTPS name. |
| `prometheus.<YOUR_BASE_DOMAIN>` | `192.168.72.2:9090` | HTTP | Prometheus starts with this HTTPS external URL. No added NPM authentication. |
