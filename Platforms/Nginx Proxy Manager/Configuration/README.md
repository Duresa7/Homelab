...
- The 19 internal application hosts use certificate ID 1, Force SSL, HTTP/2, Block Common Exploits, & WebSocket support. Immich also disables request buffering and uses a 50,000 MiB body limit with 600-second timeouts.
