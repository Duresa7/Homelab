...
I added VM 122 `net4` as a VirtIO interface on `vmbr0`, tagged VLAN 75, with Proxmox firewall filtering disabled. The controller assigned MAC `BC:24:11:8A:6A:82`, and Ubuntu named the interface `enp6s22`.
