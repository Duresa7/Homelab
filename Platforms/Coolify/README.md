...
| Coolify version | 4.3.23, updated and verified 2026-09-18 |
| Traefik runtime | 3.7.12 through the `traefik:v3.7` image tag, verified 2026-09-18 |
...
### Containers (verified 2026-09-18)

| Container | Image | Role |
|---|---|---|
| coolify | `docker.io/coollabsio/coolify:4.3.23` | Control panel & API; host `8000` maps to container `8080` |
