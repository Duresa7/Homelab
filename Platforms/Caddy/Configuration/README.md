...
This folder holds the file Caddy reads.
...
On 2026-08-04 two timestamped copies sat beside the live file on edge-01, `Caddyfile.bak.20260512-112939` and `Caddyfile.bak.20260512-112953`. They are editing residue from the 2026-05-12 write, and the [platform README](../README.md) tracks their removal.
