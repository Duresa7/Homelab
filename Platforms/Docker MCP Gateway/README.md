...
| SSH Manager server definitions | `/opt/docker/mcp-gateway/ssh-manager-servers.env`, twenty-two entries: eighteen Linux hosts, the three Windows servers added 2026-09-08, and the Windows workstation `obipc` added 2026-09-11 |
