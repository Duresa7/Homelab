...
| [3](UniFi%20Parallel%20Reads%20Hit%20Controller%20Login%20Limit%20-%202026-09-07.md) | 2026-09-07 | Parallel UniFi detail reads returned `Not connected to controller` | Separate managed containers each logged in; the controller returned HTTP 429 with `You've reached the login attempt limit`. Sequential reads succeeded after waiting | Resolved: persistent shared UniFi service deployed and concurrent reads verified |
