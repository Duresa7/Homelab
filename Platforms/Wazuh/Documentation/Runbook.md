...
2. Install or upgrade the Wazuh agent to a version supported by manager 4.14.6.
3. Confirm the client `<address>` is `192.168.72.2` and protocol is TCP/1514.
4. Create a fresh manager registration with the intended hostname. Don't reuse the removed 2026-07-13 identities.
