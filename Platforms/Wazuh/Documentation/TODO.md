...
- [ ] Upgrade the manager before any agent moves. The repository now offers only `4.14.7-1` while the manager runs `4.14.6-1`, and an agent must never be newer than its manager. Nothing can move forward until `security-01` does.
