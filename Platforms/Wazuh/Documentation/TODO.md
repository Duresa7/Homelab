...
- [ ] Phase two of file-integrity monitoring. Only `workstation` and `edge` have real watches; the other 15 agents, including `docker-main` since 2026-09-06, still carry `/etc/ssh` and `/etc/cron.d` from the `default` group.
