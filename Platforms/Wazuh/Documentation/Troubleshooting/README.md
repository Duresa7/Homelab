...
| <a id="5-immediate-service-fact-assertion-raced-wazuh-agent-startup"></a>[5](Immediate%20service%20fact%20assertion%20raced%20Wazuh%20agent%20startup%20-%202026-08-03.md) | 2026-08-03 | The first three new agents had keys and TCP sessions, but an immediate `service_facts` assertion reported the units stopped | I added a bounded `systemctl is-active` poll before the final assertion | Resolved; all five Proxmox first starts and zero-change reruns passed |

Related incident: [Manager Processes Terminated by Hash Refresh - 2026-09-11](../../../../Security/Incidents/Wazuh/Manager%20Processes%20Terminated%20by%20Hash%20Refresh%20-%202026-09-11.md).
