...
**Status:** Infrastructure operational; application onboarding completed 2026-07-17 ([onboarding record](Application%20Onboarding%20-%202026-07-17.md)); end-to-end acquisition test passed 2026-07-21
...
| S02 | Applied the Linux host baseline | Authorized-key SSH worked; root locked; root/password/keyboard-interactive SSH disabled; `dkadi` NOPASSWD sudo verified |
...
| S09 | Established the qBittorrent Web UI login | The new login worked, and the Sonarr and Radarr client tests passed |
