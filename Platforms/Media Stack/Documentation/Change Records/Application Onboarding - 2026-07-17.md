...
I completed Jellyfin's guided setup, media libraries, and hardware transcoding; Sonarr and Radarr media management; the first Prowlarr indexer; and the migrated Seerr connections to Jellyfin, Sonarr, and Radarr. The [deployment record](Deployment%20-%202026-07-17.md) and [refresh record](Refresh%20and%20Payload%20Filtering%20-%202026-07-17.md) cover the infrastructure that came first.

## UI Session and Screenshots

I performed the onboarding in each application's web UI between 20:08 and 21:14 EDT on 2026-07-17. The [evidence index](../../Evidence/Application%20Onboarding%20-%202026-07-17/Evidence-Index.md) catalogs 16 screenshots. Step 13 has no screenshot.
...
![Jellyfin guided setup with server name Jelly-Media and English display language](../../Evidence/Application%20Onboarding%20-%202026-07-17/Screenshots/S01-Jellyfin-Setup-Wizard-Server-Name-2026-07-17.png)
...
![Configured Add Media Library dialog for Movies with English and United States metadata defaults and real-time monitoring; folder picker collapsed](../../Evidence/Application%20Onboarding%20-%202026-07-17/Screenshots/S02-Jellyfin-Movies-Library-Settings-2026-07-17.png)
...
![Configured Add Media Library dialog for TV Shows with English and United States defaults and Specials season naming; folder picker collapsed](../../Evidence/Application%20Onboarding%20-%202026-07-17/Screenshots/S03-Jellyfin-TV-Library-Settings-2026-07-17.png)
...
**Verification:** The LAN UI displayed an empty queue, categories `radarr` and `tv-sonarr`, 85.35 GiB free, and DHT at zero nodes.

**Evidence:**

![qBittorrent Web UI reachable with an empty queue, radarr and tv-sonarr categories, 85.35 GiB free, and DHT idle behind the VPN](../../Evidence/Application%20Onboarding%20-%202026-07-17/Screenshots/S04-qBittorrent-WebUI-Baseline-Categories-2026-07-17.png)
...
**Observed result:** Jellyfin retained Intel QuickSync, hardware encoding, HEVC output, OS-native VA-API decoders, and the disabled AV1/HEVC RExt selections from my [media settings research](../Media%20Settings%20Research%20-%202026-07-17.md).
...
![Intel QuickSync transcoding with the researched decode and encode selections; tone-mapping fields sit below the captured viewport](../../Evidence/Application%20Onboarding%20-%202026-07-17/Screenshots/S05-Jellyfin-QSV-Transcoding-Settings-2026-07-17.png)
...
![Sonarr episode renaming with Smart Replace and Season {season} folders](../../Evidence/Application%20Onboarding%20-%202026-07-17/Screenshots/S06-Sonarr-Episode-Naming-2026-07-17.png)
...
![Sonarr television root folder /data/media/tv with 85.4 GiB free and zero unmapped folders](../../Evidence/Application%20Onboarding%20-%202026-07-17/Screenshots/S07-Sonarr-Root-Folder-TV-2026-07-17.png)
...
![Sonarr qBittorrent via Proton VPN client enabled with completed-download handling and failed-download redownload on](../../Evidence/Application%20Onboarding%20-%202026-07-17/Screenshots/S08-Sonarr-Download-Client-Handling-2026-07-17.png)
...
![Radarr movie naming with hard-links-instead-of-copy enabled and a 100 MB minimum-free-space import guard](../../Evidence/Application%20Onboarding%20-%202026-07-17/Screenshots/S09-Radarr-Movie-Naming-Hardlinks-2026-07-17.png)
...
![Radarr movie root folder /data/media/movies with 85.4 GiB free and zero unmapped folders](../../Evidence/Application%20Onboarding%20-%202026-07-17/Screenshots/S10-Radarr-Root-Folder-Movies-2026-07-17.png)
...
![Radarr six stock quality profiles with the default delay profile and no release profiles](../../Evidence/Application%20Onboarding%20-%202026-07-17/Screenshots/S11-Radarr-Quality-Delay-Profiles-2026-07-17.png)
...
**Verification:** The saved client detail displayed host `gluetun`, port 8080, and category `radarr`.

**Evidence:**

![Radarr download-client entry pointing at host gluetun port 8080 with category radarr](../../Evidence/Application%20Onboarding%20-%202026-07-17/Screenshots/S12-Radarr-qBittorrent-Client-Detail-2026-07-17.png)
...
**Observed result:** At 20:55 the enabled indexer synced through the Sonarr and Radarr application links established during deployment.

**Verification:** Prowlarr showed the indexer enabled and associated with the Standard sync profile.

**Evidence:** S13 has no screenshot. The [evidence index](../../Evidence/Application%20Onboarding%20-%202026-07-17/Evidence-Index.md) records the gap.
...
**Verification:** The library-sync page displayed `Movies` and `TV Shows` selected.

**Evidence:**

![Seerr setup wizard signed in to Jellyfin with the Movies and TV Shows libraries synced and enabled](../../Evidence/Application%20Onboarding%20-%202026-07-17/Screenshots/S14-Seerr-Jellyfin-Library-Sync-2026-07-17.png)
...
**Observed result:** Seerr returned `connection established successfully` and retained Radarr as the default server.

**Verification:** I reviewed the saved Radarr connection state before continuing.

**Evidence:**

![Seerr Radarr connection established with Radarr as default server](../../Evidence/Application%20Onboarding%20-%202026-07-17/Screenshots/S15-Seerr-Radarr-Connection-Established-2026-07-17.png)
...
![Seerr Sonarr default-server settings with HD-1080p for standard and anime series and season folders on](../../Evidence/Application%20Onboarding%20-%202026-07-17/Screenshots/S16-Seerr-Sonarr-Server-Settings-2026-07-17.png)
...
**Verification:** The Discover page displayed populated movie and television rows after the wizard completed.

**Evidence:**

![Migrated Seerr request UI rendering populated Discover metadata after wizard completion](../../Evidence/Application%20Onboarding%20-%202026-07-17/Screenshots/S17-Seerr-Discover-Populated-2026-07-17.png)

## Configuration Deviations and Evidence Gaps
