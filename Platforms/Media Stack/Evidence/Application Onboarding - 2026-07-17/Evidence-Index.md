...
**S04:** Web UI reachable at `http://192.168.40.42:8080` with an empty queue, existing `radarr` and `tv-sonarr` categories, 85.35 GiB free space, and DHT idle at zero nodes behind the VPN. On 2026-09-25 I cropped the top 70 pixels (the browser toolbar and bookmarks bar) off this capture; the qBittorrent page is unchanged.
