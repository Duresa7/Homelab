...
| Setting | Value | Notes |
|---|---|---|
| Cores | 6 (raised from 4 on 2026-07-02) | Single socket; bumped to resolve a CPU-bound Splunk ES install/setup issue — see [Splunk ES troubleshooting log](../../Splunk%20ES/Documentation/Troubleshooting-Log.md) #1 |
| Sockets | 1 | |
