# Splunk Enterprise VM Specifications
...
**Documented:** 2026-06-28; compute and disk rechecked against the cluster resource list on 2026-09-24 (6 vCPU, 12 GiB, 150 GiB)
...
| Bridge | `vmbr0` | |
| VLAN tag | **72** (Security-A, zone `AlphaSec-Observability`) | Security tier; Security-A joined the former monitor zone as `AlphaSec-Observability` in the 2026-07-27 zone consolidation |
