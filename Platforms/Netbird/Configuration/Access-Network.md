...
This is not currently a problem: Nginx Proxy Manager sits at `192.168.85.2` inside the one reachable subnet and proxies all 23 internal service names from there, so the single granted resource covers every published application.
