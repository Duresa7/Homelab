...
| <a id="2-netbird-installer-required-jq"></a>[2](Installer%20Required%20jq%20-%202026-07-10.md) | S08 | Official NetBird installer stopped because `jq` was missing | Installed Debian `jq` and reran from a clean state | Resolved |
...
| <a id="6-npm-advanced-gear-dismissed-the-proxy-host-modal"></a>[6](../../../Nginx%20Proxy%20Manager/Documentation/Troubleshooting/Unsaved%20Proxy-Host%20Modal%20Closed%20During%20Advanced%20Navigation%20-%202026-07-11.md) | S07 | NPM Advanced gear dismissed the proxy-host modal | Saved the basic host first, then applied Advanced configuration | Resolved |
