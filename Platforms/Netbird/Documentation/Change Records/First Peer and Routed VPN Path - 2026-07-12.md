...
I enrolled the first two peers, exercised the WireGuard data path, and routed one peer into Access-A through CT 107. The checks covered the overlay tunnel, route selection, HTTPS service path, and UniFi firewall behavior.
...
**Action:** I generated a one-off User Device setup key in the NetBird dashboard and ran the installer on the temporary `debian` VM.
...
![The debian peer connected on the Peers page, overlay IP 100.121.231.114, running NetBird 0.74.4 on Debian GNU/Linux 13](../../Evidence/First%20Peer%20and%20Routed%20VPN%20Path%20-%202026-07-12/Screenshots/S01-First-Peer-Debian-Connected-2026-07-12.png)
...
![The Control Center peer graph with the single debian peer (100.121.231.114) connected to the Default / All group](../../Evidence/First%20Peer%20and%20Routed%20VPN%20Path%20-%202026-07-12/Screenshots/S02-Control-Center-Single-Peer-2026-07-12.png)

### Step 3: Enroll the routing peer

**Action:** I generated a one-off Server setup key and ran the same installer on CT 107 `docker-network`.
...
![The Peers page listing docker-network (100.121.111.204) and debian (100.121.231.114), with the Add Peer menu open showing User Device, Server, and Agent](../../Evidence/First%20Peer%20and%20Routed%20VPN%20Path%20-%202026-07-12/Screenshots/S03-Peers-Two-Peers-Add-Peer-Types-2026-07-12.png)
...
**Verification:** The graph showed `debian` at `100.121.231.114` and `docker-network` at `100.121.111.204`, with no third peer.

**Evidence:**

![The Control Center peer graph with debian and docker-network both attached to the All group](../../Evidence/First%20Peer%20and%20Routed%20VPN%20Path%20-%202026-07-12/Screenshots/S04-Control-Center-Two-Peers-2026-07-12.png)
...
![ip route get 192.168.85.2 on the debian peer before the network existed, resolving via 192.168.50.1 dev eth1 over the LAN](../../Evidence/First%20Peer%20and%20Routed%20VPN%20Path%20-%202026-07-12/Screenshots/S05-Debian-Route-Before-LAN-2026-07-12.png)
...
![The Add Resource dialog for the `AlphaSec-Access` network with name Access-a-subnet and address 192.168.85.0/24](../../Evidence/First%20Peer%20and%20Routed%20VPN%20Path%20-%202026-07-12/Screenshots/S06-Add-Resource-Initial-2026-07-12.png)
...
![The Add Resource dialog with Optional Settings expanded, description "Access-A zone (VLAN 85)" and resource group access-a](../../Evidence/First%20Peer%20and%20Routed%20VPN%20Path%20-%202026-07-12/Screenshots/S07-Add-Resource-Details-2026-07-12.png)
...
![The Create New Access Control Policy dialog naming the rule "Peers → Access-A (VLAN 85)" with a validation-scope description](../../Evidence/First%20Peer%20and%20Routed%20VPN%20Path%20-%202026-07-12/Screenshots/S08-Access-Policy-Name-2026-07-12.png)
...
![The resource Access Control tab showing the Peers → Access-A policy with All source groups and ALL protocol and ports](../../Evidence/First%20Peer%20and%20Routed%20VPN%20Path%20-%202026-07-12/Screenshots/S09-Resource-Access-Policy-2026-07-12.png)
...
![The Add Routing Peer dialog with docker-network (100.121.111.204) selected as the routing peer](../../Evidence/First%20Peer%20and%20Routed%20VPN%20Path%20-%202026-07-12/Screenshots/S10-Add-Routing-Peer-Docker-Network-2026-07-12.png)
...
![The routing peer Advanced Settings with Enable Routing Peer on, Masquerade on, and metric 9999](../../Evidence/First%20Peer%20and%20Routed%20VPN%20Path%20-%202026-07-12/Screenshots/S11-Routing-Peer-Advanced-Masquerade-2026-07-12.png)
...
![The Networks list showing `AlphaSec-Access` with 1 resource, 1 policy, and 1 routing peer](../../Evidence/First%20Peer%20and%20Routed%20VPN%20Path%20-%202026-07-12/Screenshots/S12-Network-Complete-Access-2026-07-12.png)
...
![On the debian peer: ping 100.121.111.204 returns 3/3 over the tunnel, and ip route get 192.168.85.2 now resolves via dev wt0 table 7120](../../Evidence/First%20Peer%20and%20Routed%20VPN%20Path%20-%202026-07-12/Screenshots/S13-Debian-Tunnel-And-Route-Flip-2026-07-12.png)
...
![On the debian peer: ping 192.168.85.2 returns 3/3, and a raw-IP curl to https://192.168.85.2 returns a TLS unrecognized_name error with code 000](../../Evidence/First%20Peer%20and%20Routed%20VPN%20Path%20-%202026-07-12/Screenshots/S14-Debian-Routed-Reach-And-SNI-2026-07-12.png)
...
```sh
curl -k -m5 --resolve netbird.alphasecunited.com:443:192.168.85.2 \
...
**Verification:** The request returned HTTP 200 through `wt0` while preserving the published hostname for TLS SNI and the HTTP Host header.

**Evidence:**

![On the debian peer: curl with --resolve `netbird.alphasecunited.com`:443:192.168.85.2 returns HTTP 200 through the tunnel](../../Evidence/First%20Peer%20and%20Routed%20VPN%20Path%20-%202026-07-12/Screenshots/S15-Debian-HTTPS-200-Through-Tunnel-2026-07-12.png)
...
I completed the automated certificate-renewal path and bounded container logging on 2026-07-12. I intentionally descoped the remaining hardening items in [NetBird/NPM Operational Follow-ups and Hardening Descope - 2026-07-12](NPM%20Operational%20Follow-ups%20and%20Hardening%20Descope%20-%202026-07-12.md).
