...
| Image | `ollama/ollama:0.33.3` (confirmed by `/api/version` on 2026-09-24), pinned to digest `sha256:32931b46719f673c05fdbaa81ccb26da18ea4a1c57590a754874ab28ba269eb2` |
...
| Web interface | `https://openwebui.alphasecunited.com`; Open WebUI rolling `main`, 0.11.4 on 2026-09-24, authenticated, with named volume `ollama_open-webui-data` |
...
- [Deployment research](Documentation/GPU%20Docker%20Deployment%20Research%20-%202026-09-04.md)
