...
This index links the latest complete Galaxy snapshot set. I rolled the workload record forward on 2026-08-02 after adding an internal documentation workload to Docker Main. Node, VM, and LXC configuration did not change, so the current set reuses those verified snapshots.
...
| [Services - 2026-08-02.md](Services%20-%202026-08-02.md) | Current workload snapshot at 12 containers on Docker Main |
