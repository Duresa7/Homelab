...
This index links the latest complete Galaxy snapshot set. I rolled it forward on 2026-07-30 after the controlled Parrot installation, workspace changes, image-update control, and replacement VM snapshot.

| File | Contents |
| --- | --- |
| [Nodes Post-Parrot - 2026-07-30.md](Nodes%20Post-Parrot%20-%202026-07-30.md) | Current Proxmox node and storage snapshot |
| [VMs Post-Parrot - 2026-07-30.md](VMs%20Post-Parrot%20-%202026-07-30.md) | Current QEMU VM configuration snapshot |
| [LXCs Post-Parrot - 2026-07-30.md](LXCs%20Post-Parrot%20-%202026-07-30.md) | Current LXC configuration snapshot |
| [Services Post-Parrot - 2026-07-30.md](Services%20Post-Parrot%20-%202026-07-30.md) | Current workload snapshot |
