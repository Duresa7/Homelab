...
| win11-dev | VM 103 | green-server | Standalone Windows development workstation (`192.168.40.117`, VLAN 40) | Windows 11 Pro 25H2<br>OpenSSH Server<br>QEMU guest agent; no development tools installed |
...
| Workload | Details |
| --- | --- |
| Prometheus | 3.14.0 on TCP 9090; `restart: always`; 15-day retention; 57 of 57 targets `up` across seven jobs: node 17, cAdvisor 8, WUD 6, Proxmox 1, blackbox 23 (22 NPM names plus the alert bot's health endpoint), NUT 1, & self-scrape 1 |
