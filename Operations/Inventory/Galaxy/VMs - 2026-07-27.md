...
Galaxy had 10 QEMU VMs & two templates when I captured this snapshot. This inventory records each guest's CPU, memory, storage, firmware, network, VLAN, firewall, TPM, & QEMU-agent state.
