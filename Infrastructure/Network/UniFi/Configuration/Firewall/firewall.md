...
| Allow dkadi MacBook Air M3 to PeaNUT | Yes | ALLOW | 10002 | TCP | Both | Internal | IP 192.168.10.27 | `<YOUR_ORG_NAME>`-Monitor | IP 192.168.73.2 | 8090 | All | Always | On | One fixed-IP laptop on Trusted reaches the UPS dashboard only; automatic return policy enabled |
