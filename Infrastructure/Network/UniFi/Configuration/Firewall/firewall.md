...
| Allow Monitor to Proxmox NUT | Yes | ALLOW | 10001 | TCP | Both | `<YOUR_ORG_NAME>`-Monitor | IP 192.168.73.2 | `<YOUR_ORG_NAME>`-Mgmt | IPs 192.168.70.10, 192.168.70.13 | 3493 | All | Always | On | The NUT exporter reads `ups01` and `ups02`; automatic return policy enabled |
...
| Allow NPM to monitor-01 web UIs | Yes | ALLOW | 10000 | TCP | Both | `<YOUR_ORG_NAME>`-Access | IP 192.168.85.2 | `<YOUR_ORG_NAME>`-Monitor | IP 192.168.73.2 | 3000, 9090 | All | Always | On | NPM reaches Grafana and Prometheus; automatic return policy enabled |
| Allow Secure to monitor-01 break-glass | Yes | ALLOW | 10000 | TCP | Both | Internal | IP 192.168.50.241 | `<YOUR_ORG_NAME>`-Monitor | IP 192.168.73.2 | 3000, 9090 | All | Always | On | Jedi PC can reach the two web interfaces directly; automatic return policy enabled |
