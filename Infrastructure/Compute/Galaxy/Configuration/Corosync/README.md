...
I keep Corosync and `knet` configuration references, link definitions, and validated exports here. Dated implementation work lives under `Documentation/Change Records/` and cross-links the resulting configuration.
...
I set no explicit link priorities, so the lower-numbered `link0` stays preferred and `link1` provides the redundant path. The completed implementation is recorded in [Galaxy Cluster-Net Corosync Link Addition - 2026-07-10](../../Documentation/Change%20Records/Galaxy%20Cluster-Net%20Corosync%20Link%20Addition%20-%202026-07-10.md).
