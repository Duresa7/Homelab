...
| UPS-02 | APC Back-UPS RS 1500MS2 | 1500 VA / 900 W | Network core & cluster nodes | Ahsoka Gateway, Ubiquiti Cloud Gateway Fiber (`UCG-Fiber`); Bane Switch POE, Ubiquiti Switch Pro Max 16 PoE (`USW-Pro-Max-16-PoE`); `grey-server`; `blue-server`; `red-server`; Verizon ONT |

`UPS-01` & `UPS-02` are inventory identifiers. I haven't recorded matching physical labels, & serial numbers are withheld.
