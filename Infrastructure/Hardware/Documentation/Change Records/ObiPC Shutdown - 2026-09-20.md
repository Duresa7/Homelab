...
I shut down [ObiPC](../../Workstations/ObiPC.md) at 6:00 PM Eastern on 2026-09-20. Before the shutdown, `hostname` through SSH Manager returned `ObiPC` with exit code 0. I sent `shutdown.exe /s /t 0` to server `obipc` at `192.168.60.102`; it returned exit code 0 with empty stdout and stderr.
