...
| Component | Records |
| --- | --- |
| [Drives](Drives/README.md) | NVMe, SSD, and HDD units, slotted or spare, with power-on hours, wear, and health; raw SMART captures in `NVMe/`, `SSD/`, `HDD/` |

I add a type folder (GPUs, CPUs, memory, and so on) when I have a first component to record for it, so this table grows as I inventory more parts.
